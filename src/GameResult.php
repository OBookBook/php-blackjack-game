...
class GameResult
{
     ...
     * @return void
     */
    static function result($players, $dealer, $fundsManagerInstance): void
    {
        ...
        foreach ($players as $player) {
            ...
            if ($player->getRoundResult() == false && $player->getIsSurrendered() == false) {
                GameResult::handlePlayerBust($player, $fundsManagerInstance);
            }
            // プレイヤーがサレンダー
            if ($player->getRoundResult() == false && $player->getIsSurrendered() == true) {
                GameResult::handlePlayerSurrendered($player, $fundsManagerInstance);
            }
            // プレイヤーの勝ち
            if ($player->getRoundResult() == true && abs(WINNING_SCORE - $player->getScore()) < abs(WINNING_SCORE - $dealer->getScore())) {
                GameResult::handlePlayerWin($player, $fundsManagerInstance);
            }
            // ディーラーの勝ち
            if ($player->getRoundResult() == true && !(abs(WINNING_SCORE - $player->getScore()) < abs(WINNING_SCORE - $dealer->getScore()))) {
                GameResult::handleDealerWin($player, $fundsManagerInstance);
            }
        }
    ...
    // プレイヤーがバーストした場合の処理
    static function handlePlayerBust($player, $fundsManagerInstance)
    {
    ...
    // プレイヤーがサレンダーした場合の処理
    static function handlePlayerSurrendered($player, $fundsManagerInstance)
    {
    ...
    // プレイヤーが勝った場合の処理
    static function handlePlayerWin($player, $fundsManagerInstance)
    {
    ...
    // ディーラーが勝った場合の処理
    static function handleDealerWin($player, $fundsManagerInstance)
    {
